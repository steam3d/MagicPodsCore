...
namespace MagicPodsCore
{
    ...
    AppAnimationCapability::AppAnimationCapability(AapDevice& device) : AapCapability("animation", false, device)
    {
        ...
        //connectionEventId = device.GetConnectedPropertyChangedEvent().Subscribe([this](size_t id, const bool b){
        //    if (b){
        //        SendData(AapPrivateKeys());
        //    }
        //});
    ...
    AppAnimationCapability::~AppAnimationCapability()
    {
        ...
        //device.GetConnectedPropertyChangedEvent().Unsubscribe(connectionEventId);
    }

    void AppAnimationCapability::SetFromJson(const nlohmann::json &json)
    {        
    /*
